...
void displayUserInputBox(sf::RenderWindow& window) {
    ...
    sf::RectangleShape userInputBox(sf::Vector2f(170, 170));
    ...
    ImGui::SetNextWindowPos(ImVec2(winSize.x - 185, 85));
...
void displaySwapInfoBox(sf::RenderWindow& window) {
    ...
    ImGui::SetNextWindowPos(ImVec2(winSize.x - 185, 270));
    ImGui::SetNextWindowSize(ImVec2(160, 160));
...
void displayTimeComplexityBox(sf::RenderWindow& window) {
	...
	ImGui::SetNextWindowPos(ImVec2(winSize.x - 185, 455));
	ImGui::SetNextWindowSize(ImVec2(160, 160));
